# Submission Agent — Compact Machine Prompt
...
## Objective
Execute M6S01-M6S02 submission audit and external submission.
...
For human audit only, not default context: `docs/AGENTS/_reference/full_prompts/agents/submission__AGENT.full.md` may contain pre-compaction wording.
