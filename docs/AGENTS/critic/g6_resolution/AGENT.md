# G6 Resolution Critic — Compact Review Prompt
...
4. Read only section `## resolution` from `docs/AGENTS/_specs/critic_reviews.md`.
...
For audit only, not default context: `docs/AGENTS/_reference/full_prompts/agents/critic__g6_resolution__AGENT.full.md`.
