# Ethics Critic — Compact Review Prompt
...
4. Read only section `## ethics` from `docs/AGENTS/_specs/critic_reviews.md`.
...
For audit only, not default context: `docs/AGENTS/_reference/full_prompts/agents/critic__ethics__AGENT.full.md`.
