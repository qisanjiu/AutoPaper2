# M3 Dataset/Environment Reviewer — Compact Review Prompt
...
4. Read only section `## m3_dataset_env_review` from `docs/AGENTS/_specs/critic_reviews.md`.
...
For audit only, not default context: `docs/AGENTS/_reference/full_prompts/agents/critic__m3_dataset_env_review__AGENT.full.md`.
