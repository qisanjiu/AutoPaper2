# M2 Migration Reviewer — Compact Review Prompt
...
4. Read only section `## m2_migration` from `docs/AGENTS/_specs/critic_reviews.md`.
...
For audit only, not default context: `docs/AGENTS/_reference/full_prompts/agents/critic__m2_migration__AGENT.full.md`.
