# Code Review Critic — Compact Review Prompt
...
4. Read only section `## code_review` from `docs/AGENTS/_specs/critic_reviews.md`.
...
For audit only, not default context: `docs/AGENTS/_reference/full_prompts/agents/critic__code_review__AGENT.full.md`.
