# M2 Design Reviewer — Compact Review Prompt
...
4. Read only section `## m2_design_review` from `docs/AGENTS/_specs/critic_reviews.md`.
...
For audit only, not default context: `docs/AGENTS/_reference/full_prompts/agents/critic__m2_design_review__AGENT.full.md`.
