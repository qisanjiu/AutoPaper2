# Data Checker Critic — Compact Review Prompt
...
4. Read only section `## data_checker` from `docs/AGENTS/_specs/critic_reviews.md`.
...
For audit only, not default context: `docs/AGENTS/_reference/full_prompts/agents/critic__data_checker__AGENT.full.md`.
