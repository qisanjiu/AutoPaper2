# Source Log Validator — Compact Review Prompt
...
4. Read only section `## source_log_validator` from `docs/AGENTS/_specs/critic_reviews.md`.
...
For audit only, not default context: `docs/AGENTS/_reference/full_prompts/agents/critic__source_log_validator__AGENT.full.md`.
