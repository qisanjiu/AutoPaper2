# M3 Baseline Result Reviewer — Compact Review Prompt
...
4. Read only section `## m3_baseline_result_review` from `docs/AGENTS/_specs/critic_reviews.md`.
...
For audit only, not default context: `docs/AGENTS/_reference/full_prompts/agents/critic__m3_baseline_result_review__AGENT.full.md`.
