# M6 Internal Peer Reviewer — Compact Review Prompt
...
4. Read only section `## m6_internal_peer_review` from `docs/AGENTS/_specs/critic_reviews.md`.
...
For audit only, not default context: `docs/AGENTS/_reference/full_prompts/agents/critic__m6_internal_peer_review__AGENT.full.md`.
