# M4 Analysis Execution Reviewer — Compact Review Prompt
...
4. Read only section `## m4_analysis_execution_review` from `docs/AGENTS/_specs/critic_reviews.md`.
...
For audit only, not default context: `docs/AGENTS/_reference/full_prompts/agents/critic__m4_analysis_execution_review__AGENT.full.md`.
