# M4 Findings Audit Reviewer — Compact Review Prompt
...
4. Read only section `## m4_findings_audit` from `docs/AGENTS/_specs/critic_reviews.md`.
...
For audit only, not default context: `docs/AGENTS/_reference/full_prompts/agents/critic__m4_findings_audit__AGENT.full.md`.
