# Revision Agent — Compact Machine Prompt
...
## Objective
Execute M6S05 revision execution record after routed subagents complete their work.
...
For human audit only, not default context: `docs/AGENTS/_reference/full_prompts/agents/revision__AGENT.full.md` may contain pre-compaction wording.
