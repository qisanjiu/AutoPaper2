# Survey Agent — Compact Machine Prompt
...
## Objective
Execute M1S01-M1S02 survey work; maintain source logs and survey memory.
...
For human audit only, not default context: `docs/AGENTS/_reference/full_prompts/agents/survey__AGENT.full.md` may contain pre-compaction wording.
