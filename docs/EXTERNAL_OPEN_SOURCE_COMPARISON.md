...
| Partial | Append-only runtime event stream | OpenHands / PaperBench | `experiments/logs/runtime_events.jsonl` now records M3S03 watchdog checks; future work can generalize it to all M3S01/M4S03 command, retry, artifact, and approval events |
